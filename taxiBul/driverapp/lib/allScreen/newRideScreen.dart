...
import 'package:driverapp/allwidgets/collectFareDialog.dart';
...
class _NewRideScreenState extends State<NewRideScreen> {
  ...
  var locationOptions = //to get the update of the live location
  ...
  void updateRideDetails() async {
    if (isRequistingDirection == false) {
      ...
      if (status == "accepted") {
        //driver is moving to the rider
        destinationLatLng = widget.rideDetails.pickUp;
      } else {
        // driver has pickedup the rider and going to the dropup location for the rider
